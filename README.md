...
Les projets blocklyArduino sont :
 - enregistrés sous forme de fichier xml dans le dossier datas (qui pointe vers php/files) sous forme   login-10000000.xml    (login remplacé par le login de l'utilisateur et 10000000 par le timestamp de la date et l'heure d'enregistrement)
